...
DEFAULT_CLIP_TOKENIZER_DIR = PROJECT_ROOT / "models" / "clip_tokenizer"


def load_clip_tokenizer(cache_dir: str = str(DEFAULT_CLIP_TOKENIZER_DIR)):
    """
...
class Tokenizer_M:
    ...
    def __init__(self, 
        ...
        if cache_dir is None:
            cache_dir = str(DEFAULT_CLIP_TOKENIZER_DIR)
